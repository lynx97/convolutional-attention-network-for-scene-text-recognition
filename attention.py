...
class Attention:
    ...
    def multi_head(self, q, k, v):
        ...
        if self.is_training:
            ...
            return tf.nn.dropout(output, 1.0)
    ...
    def _split_heads(self, q, k, v):
        ...
        def split_last_dimension_then_transpose(tensor, num_heads, dim):
            t_shape = tensor.get_shape().as_list()    #[bs, seq_len, ori_dim]
            tensor = tf.reshape(tensor, [-1] + t_shape[1:-1] + [num_heads, dim // num_heads])         #[bs, seq_len, numhead, dim]
    ...
    def _scaled_dot_product(self, qs, ks, vs):
        ...
        o1 = tf.matmul(qs, ks, transpose_b=True)       #dot product: qs * ks.T
        ...
        o3 = tf.nn.softmax(o2)               #[bs, numhead, seq_len, seq_len]
        return tf.matmul(o3, vs)            #[bs, numhead, seq_len, dim]
